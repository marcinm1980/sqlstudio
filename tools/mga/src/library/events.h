...
namespace mga {
  ...
  // Event handling similar to Node.js' "events" implementation.
  class EventEmitter : public JSExport {
  public:
    static const size_t DEFAULT_MAX_LISTENERS = 5;
    size_t maxListeners = DEFAULT_MAX_LISTENERS;
