...
static auto create_db_sql_editor_view(std::shared_ptr<bec::UIForm> form, wb::WBContext *wb) -> FormViewBase * {
...
auto setup_sqlide(std::string &name, sigc::slot<FormViewBase *, std::shared_ptr<bec::UIForm> > &create_function) -> void {
