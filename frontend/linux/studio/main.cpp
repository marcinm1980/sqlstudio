...
#pragma GCC diagnostic pop
  ...
  std::string user_data_dir = std::string(g_get_home_dir()).append("/.mysql/studio");
...
#pragma GCC diagnostic pop
  ...
  runtime::app::get().init("com.mysql.studio", argc, argv);

  try {
    auto css = Gtk::CssProvider::create();
    css->load_from_path(wboptions.basedir + "/studio.css");
