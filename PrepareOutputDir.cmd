...
xcopy /i /s /y /d %IMAGES_DIR%\icons\MySQLMySqlStudio.ico %TARGET_DIR%\images\icons\. 1> nul 2> nul
xcopy /i /s /y /d %IMAGES_DIR%\icons\MySQLMySqlStudioDoc.ico %TARGET_DIR%\. 1> nul 2> nul
...
robocopy %PYTHON_DIR% %TARGET_DIR% python312%DEBUG_PREFIX%.dll %EXCLUDE_CMD%
...
echo * cairo library ...
xcopy /i /s /y /d %EXT_LIB_DIR%\cairo-2.dll %TARGET_DIR%\. 1> nul 2> nul
...
xcopy /i /s /y /d %EXT_LIB_DIR%\mysqlcppconn-10-vs14.dll %TARGET_DIR%\. 1> nul 2> nul
...
xcopy /i /s /y /d %AUTH_LIB_DIR%\k5sprt64.dll %TARGET_DIR%\.
xcopy /i /s /y /d %AUTH_LIB_DIR%\krb5_64.dll %TARGET_DIR%\.
xcopy /i /s /y /d %AUTH_LIB_DIR%\krbcc64.dll %TARGET_DIR%\.
xcopy /i /s /y /d %AUTH_LIB_DIR%\libsasl.dll %TARGET_DIR%\.
xcopy /i /s /y /d %AUTH_LIB_DIR%\saslSCRAM.dll %TARGET_DIR%\.
