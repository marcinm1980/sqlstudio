...
extern auto my_quick_read(File Filedes,byte *Buffer,uint Count,myf myFlags) -> uint;
extern auto my_quick_write(File Filedes,const byte *Buffer,uint Count) -> uint;
