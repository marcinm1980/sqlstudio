...
auto TextInputDialog::set_description(const std::string &text) -> void {
  _description.set_text(text);
}

auto TextInputDialog::set_caption(const std::string &text) -> void {
  _caption.set_text(text);
}

auto TextInputDialog::set_value(const std::string &text) -> void {
  _input.set_value(text);
}

auto TextInputDialog::get_value() -> std::string {
  return _input.get_string_value();
}

auto TextInputDialog::run() -> bool {
