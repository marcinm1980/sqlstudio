...
#ifndef _MYSQLSTUDIO_PHYSICAL_VIEW_IMPL_H_
#define _MYSQLSTUDIO_PHYSICAL_VIEW_IMPL_H_
...
class WBPUBLICBACKEND_PUBLIC_FUNC studio_physical_Diagram::ImplData : public model_Diagram::ImplData {
protected:
