...
#ifndef _MYSQLSTUDIO_PHYSICAL_VIEWFIGURE_IMPL_H_
#define _MYSQLSTUDIO_PHYSICAL_VIEWFIGURE_IMPL_H_
 ...
 * @ingroup Figures
 */
class WBPUBLICBACKEND_PUBLIC_FUNC studio_physical_ViewFigure::ImplData : public model_Figure::ImplData {
