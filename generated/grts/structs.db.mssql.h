...
public:
   ...
   */
  auto routineGroups() const -> grt::ListRef<db_mssql_RoutineGroup> { return grt::ListRef<db_mssql_RoutineGroup>::cast_from(_routineGroups); }
...
public:
   ...
   *    value = obj.routines
   */
  auto routines() const -> grt::ListRef<db_mssql_Routine> { return grt::ListRef<db_mssql_Routine>::cast_from(_routines); }
...
public:
   ...
   *    value = obj.sequences
   */
  auto sequences() const -> grt::ListRef<db_mssql_Sequence> { return grt::ListRef<db_mssql_Sequence>::cast_from(_sequences); }
...
public:
   ...
   */
  auto structuredTypes() const -> grt::ListRef<db_mssql_StructuredDatatype> { return grt::ListRef<db_mssql_StructuredDatatype>::cast_from(_structuredTypes); }
...
public:
   ...
   *    value = obj.synonyms
   */
  auto synonyms() const -> grt::ListRef<db_mssql_Synonym> { return grt::ListRef<db_mssql_Synonym>::cast_from(_synonyms); }
...
public:
   ...
   *    value = obj.tables
   */
  auto tables() const -> grt::ListRef<db_mssql_Table> { return grt::ListRef<db_mssql_Table>::cast_from(_tables); }
...
public:
   ...
   *    value = obj.views
   */
  auto views() const -> grt::ListRef<db_mssql_View> { return grt::ListRef<db_mssql_View>::cast_from(_views); }
...
public:
   ...
   *    value = obj.schemata
   */
  auto schemata() const -> grt::ListRef<db_mssql_Schema> { return grt::ListRef<db_mssql_Schema>::cast_from(_schemata); }
...
inline auto register_structs_db_mssql_xml() -> void {
