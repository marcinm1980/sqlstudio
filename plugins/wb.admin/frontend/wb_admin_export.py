...
#        refresh_thread.run()
    ...
    def check_mysqldump_version(self, about_to_run=False):
        ...
        if not mysqldump_version:
            if about_to_run:
                mforms.Utilities.show_error("Could not get mysqldump version", "MySqlStudio was unable to get mysqldump version. Please verify the log for more information.", "OK", "", "")
            else:
                self.print_log_message("MySqlStudio was unable to get mysqldump version")
