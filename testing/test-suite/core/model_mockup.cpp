...
auto testing::addPrivilege(SyntheticMySQLModel &model, db_RoleRef &role, db_DatabaseObjectRef obj, const char *priv) -> void {
...
auto testing::addPrivilege(SyntheticMySQLModel &model, db_RoleRef &role, const char* objectType, const char* objectName,
...
auto testing::assignRole(db_UserRef user, db_RoleRef role) -> void {
  user->roles().insert(role);
}
