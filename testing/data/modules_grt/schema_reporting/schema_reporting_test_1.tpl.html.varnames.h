...
//
const char* const ksrt1_TITLE = "TITLE";
const char* const ksrt1_SCHEMATA = "SCHEMATA";
const char* const ksrt1_SCHEMA_NAME = "SCHEMA_NAME";
const char* const ksrt1_TABLES = "TABLES";
const char* const ksrt1_TABLE_NAME = "TABLE_NAME";
const char* const ksrt1_FOOTER = "FOOTER";
