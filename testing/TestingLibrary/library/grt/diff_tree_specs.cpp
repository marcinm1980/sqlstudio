...
$describe("Sync diff") {
  ...
  $it("Regression test for bug #17454626", [this]() {
    ValueRef source_val(grt::GRT::get()->unserialize(dataDir + "/diff/sync-catalogs-rowformat/source_catalog.xml"));
    ValueRef target_val(grt::GRT::get()->unserialize(dataDir + "/diff/sync-catalogs-rowformat/target_catalog.xml"));
    ...
    std::string expected_sql = dataDir + "/diff/sync-catalogs-rowformat/good.sql";
  ...
  $it("Test for bug column rename no #19500938", [this]() {
    ValueRef source_val(grt::GRT::get()->unserialize(dataDir + "/diff/column_rename/1_src.xml"));
    ValueRef target_val(grt::GRT::get()->unserialize(dataDir + "/diff/column_rename/1_dst.xml"));
    ...
    std::string expected_sql = dataDir + "/diff/column_rename/1_expected.sql";
    std::ifstream ref(expected_sql.c_str());
    std::stringstream ss(script);
  ...
  $it("Test for bug column rename and reorder no #20128561", [this]() {
    ValueRef source_val(grt::GRT::get()->unserialize(dataDir + "/diff/column_rename/2_src.xml"));
    ValueRef target_val(grt::GRT::get()->unserialize(dataDir + "/diff/column_rename/2_dst.xml"));
    ...
    std::string expected_sql = dataDir + "/diff/column_rename/2_expected.sql";
    std::ifstream ref(expected_sql.c_str());
    std::stringstream ss(script);
  ...
  $it("Test for bug index change no #27868813", [this]() {
    ValueRef source_val(grt::GRT::get()->unserialize(dataDir + "/diff/index_change/1_src.xml"));
    ValueRef target_val(grt::GRT::get()->unserialize(dataDir + "/diff/index_change/1_dst.xml"));
    ...
    std::string expected_sql = dataDir + "/diff/index_change/1_expected.sql";
    std::ifstream ref(expected_sql.c_str());
    std::stringstream ss(script);
  ...
  $it("Diff test with CaseSensitive option 1", [this]() {
    ValueRef source_val(grt::GRT::get()->unserialize(dataDir + "/diff/index_change/2_src.xml"));
    ValueRef target_val(grt::GRT::get()->unserialize(dataDir + "/diff/index_change/2_dst.xml"));
    ...
    std::string expected_sql = dataDir + "/diff/index_change/2_expected.sql";
    std::ifstream ref(expected_sql.c_str());
    std::stringstream ss(script);
  ...
  $it("Diff test with CaseSensitive option 2", [this]() {
    ValueRef source_val(grt::GRT::get()->unserialize(dataDir + "/diff/index_change/3_src.xml"));
    ValueRef target_val(grt::GRT::get()->unserialize(dataDir + "/diff/index_change/3_dst.xml"));
    db_mysql_CatalogRef source_cat = db_mysql_CatalogRef::cast_from(source_val);
    db_mysql_CatalogRef target_cat = db_mysql_CatalogRef::cast_from(target_val);
    ...
    std::string expected_sql = dataDir + "/diff/index_change/3_expected.sql";
    std::ifstream ref(expected_sql.c_str());
    std::stringstream ss(script);
