...
$describe("mtemplate") {
  ...
  $it("Create CSV from template", [this]() {
    ...
    $expect(compare_file_contents(dataDir + "/mtemplate/test_result.csv", outputDir + "/test_result.csv")).toBeTrue();
  });
  ...
  $it("Create JSON from template", [this]() {
    ...
    $expect(compare_file_contents(dataDir + "/mtemplate/test_result.json", outputDir + "/test_result.json")).toBeTrue();
  });
  ...
  $it("Create SQL from template", [this]() {
    ...
    $expect(compare_file_contents(dataDir + "/mtemplate/test_result.sql", outputDir + "/test_result.sql")).toBeTrue();
  });
  ...
  $it("Create HTML from template", [this]() {
    ...
    $expect(compare_file_contents(dataDir + "/mtemplate/test_result.html", outputDir + "/test_result.html")).toBeTrue();
  });
